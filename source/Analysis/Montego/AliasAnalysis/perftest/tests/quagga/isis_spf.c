...
{
  int state;
  char circuit_id;    /* l1/l2 p2p/bcast CircuitID */
...
{
   char snpa[ETH_ALEN];    /* NeighbourSNPAAddress */
   char sysid[ISIS_SYS_ID_LEN];  /* neighbourSystemIdentifier */
//   char lanid[ISIS_SYS_ID_LEN + 1];  /* LAN id on bcast circuits */
...
// #endif        /* HAVE_IPV6 */
//   char prio[ISIS_LEVELS]; /* priorityOfNeighbour for DIS */
